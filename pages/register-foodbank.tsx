        ...
        <Center>
            <Box width='90vw' mt='6'>
                ...
                <SimpleGrid columns={{ base: 1, md: 4 }} spacing={10}>
                    <Feature icon={<Icon as={CheckIcon} w={5} h={5} />} title={'Sign up with us'} />
                    <Feature
                    ...
                    <FormControl as={'fieldset'} my={10}>
                        <SimpleGrid columns={2} spacing={100}>
                            <Box>
                                ...
                                <Input required id='foodbank-name' placeholder='Food Bank name' />
                                ...
                                <Input width={200} id='postcode' required placeholder='Postcode' />
